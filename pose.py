...
def imgkeypoints(inputi):
	...
	cap = cv.VideoCapture(inputi if inputi!=' ' else 0)
	...
	while cv.waitKey(1) < 0:
	    ...
	    #print(warrior_ii(dict(zip(list(BODY_PARTS.keys()),points))))
	    ...
	    cv.imwrite(inputi.replace(".jpg","o.jpg").replace(".jpeg","o.jpeg"),frame)
